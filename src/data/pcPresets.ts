  ...
  ram: [
    {
      ...
      price: 10499,
      wattage: 15,
      specs: 'DDR5 6000MHz, Low Latency CL30-36-36-76, AMD EXPO & Intel XMP',
      recommendedFor: 'The sweet spot for all modern gaming and coding workstations',
      image: 'https://images.unsplash.com/photo-1562976540-1502c2145186?w=300&q=80',
    },
    {
      id: 'ram-gskill-ripjaws-64gb',
      type: 'ram',
      name: 'G.Skill Ripjaws S5 / Flare X5 64GB (2x32GB) DDR5 6000MHz',
      brand: 'G.Skill',
      price: 18999,
      wattage: 20,
      specs: '64GB Dual Kit, DDR5 6000MHz CL32, high density heatsink',
    ...
    },
    {
      ...
      price: 22999,
      wattage: 22,
      specs: 'Ultra-fast 6400MHz, aluminum heatspreader with smooth diffused RGB light bar',
      recommendedFor: 'Enthusiast gamer + creator aesthetic rigs with high frequency',
      image: 'https://images.unsplash.com/photo-1562976540-1502c2145186?w=300&q=80',
    },
    {
      ...
      recommendedFor: 'Extreme 3D animation, large language model inference & huge data sets',
      image: 'https://images.unsplash.com/photo-1562976540-1502c2145186?w=300&q=80',
    }
  ],
...
export const PC_PRESETS: PCPreset[] = [
  ...
  },
  {
    ...
    badge: 'Design + Video Editor (1.6L)',
    targetBudget: 161990,
    budgetTier: '1_2_lakh',
  ...
  },
  {
    ...
    badge: 'Architect & Minimalist (2.6L)',
    targetBudget: 259990,
    budgetTier: '2_3_lakh',
  ...
  },
  {
    ...
    badge: 'Extreme Creator + Dev (3.6L)',
    targetBudget: 359990,
    budgetTier: '3_4_lakh',
